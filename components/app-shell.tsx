...
import { CalendarDays, CheckSquare, Clock3, Gamepad2, Home, LogOut, Menu, MessageCircle, NotebookPen, Settings, ShieldCheck, X } from "lucide-react";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-frame">
    <aside className="sidebar">
      ...
      <nav className="side-nav" aria-label="Account and communication">{utilityNav.map(item => renderLink(item, "nav-link"))}</nav>
