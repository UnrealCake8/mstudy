...
export function ClassroomPage() {
  ...
  return <AppShell><section className="page">
    <div className="page-head">
      <div><p className="eyebrow">Connected school tools</p><h1>Google Classroom</h1><p>Only work you still need to do is shown here.</p></div>
    ...
    {summary ? <div className="notice sync-summary"><strong>Synced:</strong> {summary.studentCourses + summary.teacherCourses} class{summary.studentCourses + summary.teacherCourses===1?"":"es"} · {summary.assignments} assignment{summary.assignments===1?"":"s"} to do</div> : null}

    {!connected ? <div className="connect-card">
      <div className="connect-icon"><GraduationCap size={26}/></div>
      <div><h2>Connect Google Classroom</h2><p>See your classes, upcoming work and due dates without copying assignments into MStudy yourself.</p></div>
